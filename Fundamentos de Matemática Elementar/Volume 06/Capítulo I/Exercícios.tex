...
\item $f(z) = z^2 - z + 1, f(1-i) = ?$

$\color{red}f(1-i)= (1,-1)^2 - (1,-1) + (1,0) = (0,-2) + (0,1) = -i$

\vspace{10pt}

\item $f(z) = z^4 + iz^3 - (1+2i)z^2 + 3z + 1 + 3i, f(1+i) = ?$
...
\item Prove que $(1+i)^2 = 2i$ e coloque na forma algébrica $z =
...
\item Prove que $(1-i)^2 = -2i$ e calcule $(1-i)^{96} + (1-i)^{97}$
...
\item Se $i^2 = -1$, calcule $(1+i)^{12} - (1-i)^{12}$

$\color{red}= (2i)^6 - (-2i)^6 = -2^6 + 2^6 = 0$

\vspace{10pt}

\item Simplifique $\displaystyle
...
\item A igualdade $(1+i)^n = (1-i)^n$ é válida para os números
naturais divisíveis por qual natural?

\color{red}
\begin{itemize}
\item Para $n = 2k, k \in \mathbb{N} \Rightarrow ((1+i)^2)^k =
((1-i)^2)^k \Rightarrow (2i)^k = (-2i)^k \Rightarrow 2^k i^k = (-1)^k 2^k i^k$
...
\item $\color{red}(x+yi)(3+4i) = 7+26i \quad (3x-4y, 4x+3y) = (7,26) \Rightarrow
\begin{cases} 3x-4y=7 \\ 4x+3y=26
\end{cases}$

$\color{red} \cancel{3x} - 4y - \frac{3}{\cancel{4}}\cancel{4x} - \frac{3}{4}
...
\item $\color{red} (x+yi)(2+3i) = 1+8i \quad (2x-3y, 3x+2y) = (1,8) \Rightarrow
\begin{cases} 2x-3y=1 \\ 3x+2y=8
\end{cases}$

$\color{red}\displaystyle \cancel{2x} - 3y - \frac{2}{\cancel{3}}\cancel{3x} -
...
\item $\color{red} (x+yi)^2 = 2i \Rightarrow (x^2-y^2, 2xy) = (0,2) \Rightarrow
...
$\color{red}\displaystyle\Rightarrow 3x + \frac{x}{3} = 20 \Rightarrow 9x+x = 3
...
\item $(a,b)(c,d) = (ac-bd, ad+bc) = (x,0), x \in \mathbb{R}$
...
\item $(a,b)^2 \Rightarrow (a^2-b^2, 2ab)^2 = ((a^2-b^2)^2 - 4a^2b^2,
4ab(a^2-b^2))$
...
$\Rightarrow 2. \ (a^2-b^2)^2 - 4a^2b^2 < 0 \Rightarrow (a^2-b^2)^2 < 4a^2b^2$
\begin{itemize}
\item[$\bullet$] $a=0, b \neq 0 \Rightarrow (-b^2)^2 < 0 \Rightarrow
b^4 < 0 \Rightarrow \text{\Large $\lightning$}$
